 ...
 */
   ...
   */
  var Sha1 = function sha1(name, options) {
    this.constructor(name, options);
  };
  Sha1.prototype = Object.create(CryptoApi.Hasher32be.prototype);
  /**
   * @memberOf Sha1
   * @constructor
   */
  ...
  Sha1.prototype.processBlock = function processBlock(M) {
    ...
    for (var i = 0; i < 80; i++) {
      if (i < 16) {
        ...
        this.W[i] = CryptoApi.Tools.rotateLeft(this.W[i - 3] ^ this.W[i - 8] ^ this.W[i - 14] ^ this.W[i - 16], 1) | 0;
      }
