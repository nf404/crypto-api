;(
    ...
    function (CryptoApi) {
        ...
        Sha0.prototype = Object.create(CryptoApi.BaseHasher.prototype);
        /**
         * @memberOf Sha0
         * @constructor
         */
        Sha0.prototype.constructor = function () {
            CryptoApi.BaseHasher.prototype.constructor.call(this);
            /**
             * @desc Hash state
             * @memberOf! Sha0#
             * @alias state.hash
        ...
        // Transform constants
        Sha0.prototype.K = [0x5a827999, 0x6ed9eba1, 0x8f1bbcdc, 0xca62c1d6];

        Sha0.prototype.unitOrder = 1; // Reverse order of bytes
