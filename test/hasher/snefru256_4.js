...
class TestSnefru256_4 extends TestHasher {
  constructor() {
    super();

    this.data = {
      "snefru256_4('')": {
        options: {length: 256, rounds: 4},
        message: '',
...
export default TestSnefru256_4