    ...
    var TestVectorsHmac = {
        ...
        'md5': {
            "hmac-md5('Hi There', 0x0b x 16)": {
                message: 'Hi There',
                key: Array.apply(null, Array(16)).map(Number.prototype.valueOf, 0x0b),
            ...
            "hmac-md5(0xdd x 50, 0xaa x 16)": {
                message: Array.apply(null, Array(50)).map(Number.prototype.valueOf, 0xdd),
                key: Array.apply(null, Array(16)).map(Number.prototype.valueOf, 0xaa),
                hash: '56be34521d144c88dbb8c733f0e8b3f6'
            },
            "hmac-md5(0xcd x 50, 0x0102030405060708090a0b0c0d0e0f10111213141516171819)": {
                message: Array.apply(null, Array(50)).map(Number.prototype.valueOf, 0xcd),
            ...
            "hmac-md5('Test With Truncation', 0x0c x 16)": {
                ...
                key: Array.apply(null, Array(16)).map(Number.prototype.valueOf, 0x0c),
                hash: '56461ef2342edc00f9bab995690efd4c'
            },
            "hmac-md5('Test Using Larger Than Block-Size Key - Hash Key First', 0xaa x 80)": {
                message: 'Test Using Larger Than Block-Size Key - Hash Key First',
                key: Array.apply(null, Array(80)).map(Number.prototype.valueOf, 0xaa),
        ...
        'sha1': {
            "hmac-sha1('Hi There', 0x0b x 20)": {
                message: 'Hi There',
                key: Array.apply(null, Array(20)).map(Number.prototype.valueOf, 0x0b),
            ...
            "hmac-sha1(0xdd x 50, 0xaa x 20)": {
                message: Array.apply(null, Array(50)).map(Number.prototype.valueOf, 0xdd),
                key: Array.apply(null, Array(20)).map(Number.prototype.valueOf, 0xaa),
            ...
            "hmac-sha1('Test With Truncation', 0x0c x 20)": {
                message: 'Test With Truncation',
                key: Array.apply(null, Array(20)).map(Number.prototype.valueOf, 0x0c),
        ...
        'sha224': {
            ...
            "hmac-sha224('Test Using Larger Than Block-Size Key - Hash Key First', 0xaa x 131)": {
                message: 'Test Using Larger Than Block-Size Key - Hash Key First',
                key: Array.apply(null, Array(131)).map(Number.prototype.valueOf, 0xaa),
